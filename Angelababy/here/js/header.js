        ...
        <div class="header_left lf">
          <ul>
            ...
            <li>
              ...
              <ul class="height_1">
                <li><a href="#">美图秀秀</a></li>
                <li><a href="meiyan.html" target="_blank">美颜相机</a></li>
                <li><a href="#">美拍</a></li>
            ...
            <li>
              ...
              <i></i>
              <ul class="height_2">
                <li><a href="index.html" target="_blank">美图拍照手机</a></li>
                <li><a href="Bf1.html" target="_blank">美图相机</a></li>
              </ul>
            </li>
            <li>
        ...
        <div class="header_right rt">
          <ul>
            ...
            <li class="shopping">
              ...
              <div>
                <p class='nopro'>
                  购物车中还没有商品,<a href="buycar.html">现在去挑选</a>
                </p>
                <ul class='hpro'></ul>
              </div>
            </li>
      ...
      <div class="clear">
        <div class="img lf">
          <a href="index.html" target="_blank">
           <img src="images/logo@2x.png-20151104.png" class="lf">
          </a>
          <b></b>
        </div>
          ...
          <ul id="ul">
              ...
              <ul class="tanchu" id="tu1">
                <li>
                  <a href="M6.html" target="_blank">
                    <img src="images/575692160a7c882237.jpg!thumb220.jpg">
                  </a>
                  <span>美图M6</span>
                </li>
                <li>
                  <a href="#">
                    <img src="images/5756a4257695257481.jpg!thumb220.jpg">
                  </a>
                  <span>美图V4s</span>
                </li>
                <li>
                  <a href="M6.html" target="_blank">
                    <img src="images/57a7ec157bbcc60544.jpg!thumb220.jpg">
                  </a>
                  <span>美图M6(特别版 月光白)</span>
                </li>
                <li>
                  <a href="V6.html" target="_blank">
                    <img src="images/56679b68cdac460636.jpg!thumb220.jpg">
                  </a>
                  <span>美图V6</span>
                </li>
                <li>
                  <a href="#">
                    <img src="images/575693855737e81141.jpg!thumb220.jpg">
                  </a>
                  <span>美图M4s</span>
                </li>
              </ul>
            ...
            ,document.getElementById('tu3').style.visibility='visible'">
              ...
              <ul class="tanchu zhongzhongzhong"  id="tu2">
                <li>
                  <a href="Bf1.html" target="_blank">
                    <img src="images/564acb7e6cf8474119.jpg!thumb220.jpg">
                  </a>
                  <span>美图BF1</span>
                </li>
              </ul>
            ...
            ,document.getElementById('tu1').style.visibility='visible'
            ,document.getElementById('tu2').style.visibility='visible'">
              <a href="buycar.html">配 件</a>
              <ul class="tanchu zuozuozuo"  id="tu3">
                <li>
                  <a href="#">
                    <img src="images/56d80b511c3ce57438.jpg!thumb220.jpg">
                  </a>
                  <span>美图V4电源适配</span>
                </li>
                <li>
                  <a href="#">
                    <img src="images/56efc9c440cbd49231.jpg!thumb220.jpg">
                  </a>
                  <span>美图V4/V4s钢化玻璃贴膜</span>
                </li>
                <li>
                  <a href="#">
                    <img src="images/570c92e64879a59695.jpg!thumb220.jpg">
                  </a>
                  <span>美图V4/V4s 360度旋转支架</span>
                </li>
                <li>
                  <a href="#">
                    <img src="images/5621b24e25e6248824.jpg!thumb220.jpg">
                  </a>
